...
* DIC: Para o modelo ICAR, o DIC é $544.1125$, enquanto para o modelo SAR é $543.6517$. Valores mais baixos de DIC indicam melhor ajuste do modelo aos dados, com penalização pela complexidade. Neste caso, o modelo SAR apresenta um DIC ligeiramente melhor que o ICAR, sugerindo que o modelo SAR tem uma melhor adequação aos dados, levando em consideração a simplicidade do modelo.

* WAIC: O WAIC do modelo ICAR é $545.2054$ e o do modelo SAR é $545.6971$. O WAIC também é uma métrica que penaliza a complexidade do modelo, sendo que valores mais baixos indicam um melhor modelo. O ICAR tem um valor de WAIC ligeiramente melhor, indicando que o modelo ICAR pode ser um pouco mais eficiente em termos de ajuste aos dados em relação ao SAR.

* Log-verossimilhança: A log-verossimilhança do modelo ICAR é $-2157.6876$, enquanto para o SAR é $-2165.3460$. O valor da log-verossimilhança mais próximo de zero é melhor, já que um valor mais negativo indica um ajuste pior. Nesse caso, o modelo ICAR tem uma log-verossimilhança mais alta (menos negativa), o que sugere um melhor ajuste em termos de log-verossimilhança.

Comparando as métricas, os resultados entre os modelos ICAR e SAR são muito semelhantes, com pequenas diferenças nos valores de DIC, WAIC e log-verossimilhança. O modelo ICAR apresenta um desempenho ligeiramente melhor em termos de WAIC e log-verossimilhança. No entanto, as diferenças são pequenas, o que indica que ambos os modelos têm um desempenho muito próximo e são igualmente válidos
